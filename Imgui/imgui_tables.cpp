...
static const float TABLE_RESIZE_SEPARATOR_FEEDBACK_TIMER = 0.06f;   // DelayCompnent/timer before making the hover feedback (color+cursor) visible because tables/columns tends to be more cramped.
